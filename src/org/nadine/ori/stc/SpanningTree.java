...
public class SpanningTree {
	 ...
	 protected SpanningTree() {
		 ...
		 // Bounding the room
		 for (int i=-2; i<=2; i++) {
			 Coord c = new Coord(i, -2);
			 putValue(c, null, true);
			 Coord c2 = new Coord(i, 2);
			 putValue(c2, null, true);
			 Coord c3 = new Coord(-2, i);
			 putValue(c3, null, true);
			 Coord c4 = new Coord(2, i);
			 putValue(c4, null, true);
		 }
		 /////////////////////////
	 }
